...
public class StudentDao {
	...
	public static List<Student> createStudents() {
		...
		students.add(new Student("Frank", 2018, 49, LocalDate.of(1996, 11,11)));
		students.add(new Student("Gary", 2017,88, LocalDate.of(1996, 11,19)));
		...
		students.add(new Student("John", 2017, 52, LocalDate.of(1997, 11,10)));
		return students;
	}
}
